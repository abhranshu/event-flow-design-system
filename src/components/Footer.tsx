    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div>
            <h3 className="text-xl font-display font-bold text-white mb-4">Event<span className="text-event-teal">Hub</span></h3>
            <p className="text-sm mb-4">
              Discover events that match your interests or create your own. 
              Connect with people and build communities around shared passions.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/events" className="text-sm hover:text-white transition-colors">Events</Link></li>
          ...
          <div>
            ...
            <address className="not-italic">
              <p className="text-sm mb-2">#8 Krishna Kuteera RR Nagar</p>
              <p className="text-sm mb-2">Banglore, Karnataka 560098</p>
              <p className="text-sm mb-4">India</p>
              <p className="text-sm mb-2">Email: abhranshu1@gmail.com</p>
              <p className="text-sm">Phone: +91 9905883384</p>
            </address>
          </div>
        </div>
